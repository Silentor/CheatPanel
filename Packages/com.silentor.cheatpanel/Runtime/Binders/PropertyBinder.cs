...
namespace Silentor.CheatPanel.Binders
{
    ...
    /// </summary>
    public class PropertyBinder<TField, TProperty> : CheatFieldBinderBase
    {
        ...
        public PropertyBinder(  BaseField<TField> field, PropertyInfo  property, ICheats cheatObject,
